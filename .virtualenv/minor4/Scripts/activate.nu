...
def-env activate-virtualenv [] {
    ...
    let virtual-env = 'C:\Users\Rajeswar Sharma\Desktop\project\minorprojrct-4\.virtualenv\minor4'
    let bin = 'Scripts'
    let path-sep = ';'
...
alias deactivate = source 'C:\Users\Rajeswar Sharma\Desktop\project\minorprojrct-4\.virtualenv\minor4\Scripts\deactivate.nu'
